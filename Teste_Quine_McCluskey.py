...
class TestQuineMcCluskey(unittest.TestCase):
    ...
    #def teste_compara_indices(self):
        #self.assertEquals(compara_indices(['001', '011', '100', '1000', '101', '110']), (['0_1', '_01', '10_', '1_0', '10_', '1_0'], [], {'0_1': [1, 3], '_01': [1, 5], '10_': [8, 5], '1_0': [8, 6]}))
        #self.assertEquals(compara_indices(['00_', '_00', '0_1', '_01', '10_', '1_0'], []), (['_0_', '_0_'], ['0_1', '1_0'], {'00_': [0, 1], '_00': [0, 4], '0_1': [1, 3], '_01': [1, 5], '10_': [4, 5], '1_0': [4, 6], '_0_': [0, 1, 4, 5]}))
        #self.assertEquals(compara_indices( ['_0_', '_0_'], ['0_1', '1_0', '0_1', '1_0']), ([], ['0_1', '1_0', '0_1', '1_0', '_0_', '_0_'], {'00_': [0, 1], '_00': [0, 4], '0_1': [1, 3], '_01': [1, 5], '10_': [4, 5], '1_0': [4, 6], '_0_': [0, 1, 4, 5]}))
        #self.assertEquals(compara_indices(['_0_', '_0_'], ['0_1', '1_0', '0_1', '1_0', '_0_', '_0_', '_0_', '_0_', '0_1', '1_0', '0_1', '1_0', '_0_', '_0_', '_0_', '_0_', '0_1', '1_0', '0_1', '1_0']), ([], ['0_1', '1_0', '0_1', '1_0', '_0_', '_0_', '_0_', '_0_', '0_1', '1_0', '0_1', '1_0', '_0_', '_0_', '_0_', '_0_', '0_1', '1_0', '0_1', '1_0', '_0_', '_0_'], {'00_': [0, 1], '_00': [0, 4], '0_1': [1, 3], '_01': [1, 5], '10_': [4, 5], '1_0': [4, 6], '_0_': [0, 1, 4, 5]}))

    #def teste_compara_n_vezes(self):
        #self.assertEquals(compara_n_vezes(["000", "001", "011", "100", "101", "110"]), (['0_1', '1_0', '_0_', '_0_'], {'0_1': [1, 3], '1_0': [4, 6], '_0_': [0, 1, 4, 5]}))
        #self.assertEquals(compara_n_vezes(["0000", "0011", "0110", "0101", "1100"]), (['0000', '0011', '0101', '0110', '1100'], {}))
    ...
    def teste_transforma_em_variaveis(self):
        self.assertEquals(transforma_em_variaveis("a'b'c' + ab'c + abc' + a'b'c + a'bc + ab'c'", ['000', '001', '011', '100', '101', '110'], ['0_1', '1_0', '_0_']), "a'c + ac' + b'")